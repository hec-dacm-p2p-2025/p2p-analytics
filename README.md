...
- BUY–SELL spreads on Binance P2P markets  
...
│ │ ├─ io.py # Data loader functions
│ │ ├─ spreads.py # Spread & intraday analytics
│ │ ├─ premium.py # Official vs P2P premium
│ │ ├─ microstructure.py # Order imbalance & liquidity
│ │ └─ summary.py # Summary stats & volatility
│ │
│ ├─ tests/
...
```bash
git clone https://github.com/hec-dacm-p2p-2025/p2p-analytics.git
...
Compute absolute and percentage BUY–SELL spreads.
